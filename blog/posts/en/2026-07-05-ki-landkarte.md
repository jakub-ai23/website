...
1. **Who is the maker?** (Anthropic, OpenAI, Google, Mistral. Or an interface like Copilot that uses their models.)
2. **Which model?** (Small, middle, large.)
3. **Is the middle model enough?** (Usually yes.)
